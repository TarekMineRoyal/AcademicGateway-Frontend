...
export default function RegisterWizard() {
  ...
  return (
    <div onKeyDown={handleKeyDownEnforcement} className="w-full max-w-lg flex flex-col items-center">
      ...
      <div className="bg-white p-8 rounded-card shadow-xl border border-slate-100 w-full transition-all duration-300 flex flex-col">
      ...
      <div className="w-full text-center mt-6 text-xs text-slate-400 font-medium">
