import StudentPersonalInfoForm from './components/StudentPersonalInfoForm';
import StudentAcademicInfoForm from './components/StudentAcademicInfoForm';
import StudentProfileReadOnlyView from './components/StudentProfileReadOnlyView';
import { SkillPickerSection } from '@/features/skills';
import { useStudentProfileForm } from './hooks/useStudentProfileForm';

/**
 * Root container component for managing and viewing the student academic profile.
 */
